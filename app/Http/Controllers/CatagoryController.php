...
class CatagoryController extends Controller
{
    public function index()
    {
        ...
        return view("Admin.Page.Product.Category.catagory_add", ["cetagoryexist" => "yes", "catagory" => $catagory, "subcata" => $subCatagory]);
    }
    ...
    public function catagory_show()
    {
        $catagory = CategoryProduct::all();
        $subcatagory = SubCatagory::all();
        return view("Admin.Page.Product.Category.catagorytable", ["data" => $catagory, "subcat" => $subcatagory]);
    }
