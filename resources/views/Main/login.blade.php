                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form method="POST">
                        ...
                        <div data-mdb-input-init class="form-outline mb-3" style="position: relative;">
                            ...
                            <input type="password" name="password" id="password" value="{{old('password')}}" class="form-control form-control-lg" placeholder="Enter password" />
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            ...
                            <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="/Welcome" class="link-danger">Register</a></p>
                        </div>
