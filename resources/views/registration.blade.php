                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" method="post" action="/CustomerRegistration">
                                        @csrf
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                                <label class="form-label" for="form3Example1c">Your Name</label>
                                                <input type="text" id="form3Example1c" value="{{old('name')}}" name='name'
                                                    class="form-control" />
                                                    @error('name')
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="text" id="form3Example1c" value="{{old('address')}}" name="address"
                                                    class="form-control" />
                                                    @error('address')
                                                    <div style="color:red;">{{$message}}</div>
                                                @enderror
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="text" id="form3Example1c" value="{{old('phone')}}" name="phone"
                                                    class="form-control" />
                                                    @error('phone')
                                                    <div style="color:red;">{{$message}}</div>
                                                @enderror
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="text" id="form3Example3c" value="{{old('email')}}" name="email"
                                                    class="form-control" />
                                                    @error('email')
                                                    <div style="color:red;">{{$message}}</div>
                                                @enderror
                                        ...
                                        <div class="form-check d-flex justify-content-center mb-5">
                                            ...
                                            <label class="form-check-label" for="form2Example3">
                                                You have an account <a href="/CustomerLogin">Login In</a>
                                            </label>
                                        </div>
