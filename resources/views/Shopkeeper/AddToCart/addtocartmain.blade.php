        ...
        <div class="col-8">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-4">
                            <a href="/ProductDetailsShow/{{$item->product->id}}">
                            ...
                            <div class="d-flex justify-content-end">
                                <div style="border-radius: 8px;text-align: center;margin-right: 11px;text-decoration: none;font-weight: bold;">
                                    <p style="margin-top: 27px;">
                                        {{-- <a href="/deletetocart/{{$item->id}}" --}} <div data-bs-toggle="modal" data-bs-target="#removecart" style="text-decoration: none;color:red; cursor: pointer;">remove
                                        </div>
                                        <!--Remove Cart Modal -->
                                            ...
                                            <div class="modal-dialog modal-sm modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer justify-content-center">
                                                        <a href="/deletetocart/{{$item->id}}"><button type="button" class="btn btn-primary">REMOVE</button></a>
