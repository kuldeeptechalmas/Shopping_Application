...
<div class="modal fade" id="deletesubcatagory" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-danger closemodel" onclick="deleteReacordSubCatagory()">Delete</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="deletecatagory" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-danger closemodel" onclick="deleteReacordCatagory()">Delete</button>
            </div>
        </div>
    </div>
</div>
