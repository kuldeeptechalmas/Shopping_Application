...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-6"></div>
        <div class="col">
            <button type="submit" class="btn btn-primary" onclick="getprofileuser('{{$customer_profile->email}}')"
                ...
                <div class="d-flex flex-row align-items-center mb-4">
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example1c">Gender :</label><br> <input disabled type="radio"
                            value="male" {{$customer_profile->gender == 'male' ? 'checked' : '' }} />Male<input type="radio"
                            value="female" disabled {{$customer_profile->gender == 'female' ? 'checked' : '' }} />Female
                    </div>
                </div>
            </div>
            <div class="col-4">
